import { getPropertyType, isIntrinsicType, validateDecoratorNotOnType, } from "../core/decorator-utils.js";
...
const [getKnownValues, setKnownValues] = useStateMap(createStateSymbol("knownValues"));
/**
...
export const $discriminator = (context, entity, propertyName) => {
    ...
    if (entity.kind === "Union") {
        reportDeprecated(context.program, "@discriminator on union is deprecated. Use `@discriminated` instead. `@discriminated(#{envelope: false})` for the exact equivalent.", context.decoratorTarget);
