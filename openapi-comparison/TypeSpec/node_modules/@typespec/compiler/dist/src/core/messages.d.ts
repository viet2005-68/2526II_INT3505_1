...
declare const diagnostics: {
    ...
    readonly "visibility-legacy": {
        readonly severity: "warning";
        readonly messages: {
            readonly default: import("./types.js").CallableMessage<["modifier", "newModifier"]>;
            readonly unrecognized: import("./types.js").CallableMessage<["modifier"]>;
            readonly none: "String (legacy) visibility modifier 'none' should be replaced with '@invisible(Lifecycle)'. This warning will become an error in TypeSpec 1.0-rc.";
        };
    };
    ...
    readonly "operation-visibility-constraint-empty": {
        readonly severity: "warning";
        readonly messages: {
            readonly default: "Operation visibility constraints with no arguments are deprecated and will become an error in TypeSpec version 1.0-rc.";
            readonly returnType: "Return type visibility constraints with no arguments are deprecated and will become an error in TypeSpec version 1.0-rc.";
            readonly parameter: "Parameter visibility constraints with no arguments are deprecated and will become an error in TypeSpec version 1.0-rc. To disable effective PATCH optionality, use @patch(#{ implicitOptionality: false }) instead.";
        };
    };
