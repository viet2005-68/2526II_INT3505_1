...
const flagsNames = [
    ...
    [512 /* SymbolFlags.Projection */, "Projection"],
    [1024 /* SymbolFlags.Decorator */, "Decorator"],
    [2048 /* SymbolFlags.TemplateParameter */, "TemplateParameter"],
    [4096 /* SymbolFlags.ProjectionParameter */, "ProjectionParameter"],
    [8192 /* SymbolFlags.Function */, "Function"],
    [16384 /* SymbolFlags.FunctionParameter */, "FunctionParameter"],
    [32768 /* SymbolFlags.Using */, "Using"],
    [65536 /* SymbolFlags.DuplicateUsing */, "DuplicateUsing"],
    [131072 /* SymbolFlags.SourceFile */, "SourceFile"],
    [262144 /* SymbolFlags.Member */, "Member"],
    [524288 /* SymbolFlags.Const */, "Const"],
];
